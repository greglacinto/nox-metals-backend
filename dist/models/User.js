...
class UserModel {
    static async create(userData) {
      ...
      VALUES (?, ?, ?)
    `;
        const result = await database_1.default.insert(sql, [email, passwordHash, role]);
    ...
    static async updateRole(id, role) {
        ...
        await database_1.default.query(sql, [role, id]);
